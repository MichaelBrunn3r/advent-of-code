...
| 19  | [Aplenty](https://adventofcode.com/2023/day/19)                        |  `5.0µs` `2.8µs` `10.5µs` | [`About`](./2023/day-19) [`Code`](./2023/day-19/src/lib.rs) |
...
<!-- (5.7 + 43.1) + (1 + 1) + (441.2 + 30.6) + (2.2 + 3.7) + (2.9595 + 0.70056 + 12.416) + (0.034067 + 0.020762) + (18.899 + 18.772) + (1.2824 + 27.980 + 63.525) + (5.9249 + 4.5359 + 4.6842) + (4.8902 + 31.198 + 46.112) + (105.8 + 105.4) + (173.74 + 1949.5) + (48.197 + 4.9156 + 8.3080) + (6.2 + 8700) + (12.5 + 39.7) + (5.0801 + 2.8458 + 10.543) + (0.062442 + 0.016095 + 0.012819) -->
