...
| Day | Problem                              | Time                         |
| --- | ------------------------------------ | ---------------------------- |
| 1   | [Historian Hysteria](./2024/day-1)** | `3.53 µs` `9.62 µs` `947 ns` |
| 2   | [Red-Nosed Reports](./2024/day-2)**  | `5.88 µs` `12.18 µs`         |
| 3   | [Mull It Over](./2024/day-3)**       | `8.80 µs` `7.28 µs`          |
| 4   | [Ceres Search](./2024/day-4)**       | `52.64 µs` `11.80 µs`        |
| 5   | [Print Queue](./2024/day-5)**        | `23.98 µs` `41 ns` `4.39 µs` |
| 6   | [Print Queue](./2024/day-6)*         |                              |
| 7   | [Bridge Repair](./2024/day-7)**      | `36.53 µs` `31.36 µs`        |
<!-- END Table_2024 -->
...
| 14  | [Parabolic Reflector Dish](https://adventofcode.com/2023/day/14)       |           `3.8µs` `8.7ms` | [`About`](./2023/day-14) [`Code`](./2023/day-14/src/lib.rs) |
...
| 19  | [Aplenty](https://adventofcode.com/2023/day/19)                        |   `4.8µs` `2.8µs` `8.7µs` | [`About`](./2023/day-19) [`Code`](./2023/day-19/src/lib.rs) |
| 20  | [Pulse Propagation](https://adventofcode.com/2023/day/20)              |  `47.2ns` `16ns` `12.8ns` | [`About`](./2023/day-20) [`Code`](./2023/day-20/src/lib.rs) |
...
<!-- (5.7 + 43.1) + (1 + 1) + (441.2 + 30.6) + (2.2 + 3.7) + (2.9595 + 0.70056 + 12.416) + (0.034067 + 0.020762) + (18.899 + 18.772) + (1.2824 + 27.980 + 63.525) + (5.9249 + 4.5359 + 4.6842) + (4.8902 + 31.198 + 46.112) + (105.8 + 105.4) + (173.74 + 1949.5) + (48.197 + 4.9156 + 8.3080) + (3.8940 + 8711.6) + (12.5 + 39.7) + (4.8881 + 2.8458 + 8.7293) + (0.047253 + 0.016095 + 0.012819) -->
